 ...
 * @author Masadow
 */
class FlxBaseTile<TilemapKind> extends FlxObject
{
	/**
	 ...
	 */
	public var tilemap:TilemapKind;
	/**
	 ...
	 */
	public function new(Tilemap:TilemapKind, Index:Int, Width:Float, Height:Float, Visible:Bool, AllowCollisions:Int)
	{
